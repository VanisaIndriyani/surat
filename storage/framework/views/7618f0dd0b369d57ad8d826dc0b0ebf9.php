...
<?php $__env->startSection('title', 'Daftar Surat - Arsip Surat Ngodingyuk'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <a href="<?php echo e(route('surat.create')); ?>" class="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 flex items-center">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-2">
                ...
                <p class="text-gray-700 font-medium">
                    Menampilkan <span class="font-bold text-indigo-600"><?php echo e($surats->firstItem() ?? 0); ?></span> - 
                    <span class="font-bold text-indigo-600"><?php echo e($surats->lastItem() ?? 0); ?></span> dari 
                    <span class="font-bold text-indigo-600"><?php echo e($surats->total()); ?></span> surat
                </p>
            </div>
            <?php if($jenis == 'masuk'): ?>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 transition-all duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-semibold text-gray-900"><?php echo e($surat->nomor_surat); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-700"><?php echo e($surat->nomor_agenda); ?></span>
                        </td>
                        <td class="px-6 py-4">
                            <div class="max-w-xs">
                                <p class="text-sm font-medium text-gray-900 truncate" title="<?php echo e($surat->perihal); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-3 py-1 rounded-lg bg-gray-100 text-gray-700 text-sm font-medium">
                                <i class="fas fa-calendar mr-2 text-gray-400"></i><?php echo e($surat->tanggal->format('d/m/Y')); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-700"><?php echo e($surat->pengirim); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        <td colspan="9" class="px-6 py-16 text-center">
                            <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-12 border-2 border-dashed border-gray-300">
                                ...
                                <p class="text-sm text-gray-500 mb-6">Belum ada surat <?php echo e($jenis == 'masuk' ? 'masuk' : 'keluar'); ?> yang ditambahkan</p>
                                <a href="<?php echo e(route('surat.create')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl font-semibold">
        ...
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex-1 flex justify-between sm:hidden">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($surats->previousPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-xl text-gray-700 bg-white hover:bg-indigo-50 hover:border-indigo-300 transition-all">
                            <i class="fas fa-chevron-left mr-2"></i>Sebelumnya
                        </a>
                    <?php endif; ?>
                    
                    <?php if($surats->hasMorePages()): ?>
                        <a href="<?php echo e($surats->nextPageUrl()); ?>" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-xl text-gray-700 bg-white hover:bg-indigo-50 hover:border-indigo-300 transition-all">
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700 font-medium">
                            Menampilkan <span class="font-bold text-indigo-600"><?php echo e($surats->firstItem()); ?></span> sampai 
                            <span class="font-bold text-indigo-600"><?php echo e($surats->lastItem()); ?></span> dari 
                            <span class="font-bold text-indigo-600"><?php echo e($surats->total()); ?></span> hasil
                        </p>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\IZSAA\BBB\LARAVEL\SURAT\arsip-surat\resources\views/surat/index.blade.php ENDPATH**/ ?>