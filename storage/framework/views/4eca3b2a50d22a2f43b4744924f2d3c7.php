                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                class="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 pl-9 sm:pl-11 text-sm sm:text-base border-2 border-gray-200 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 input-focus <?php $__errorArgs = ['email'];
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                id="password" 
                                name="password" 
                                class="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 pl-9 sm:pl-11 pr-9 sm:pr-11 text-sm sm:text-base border-2 border-gray-200 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 input-focus <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:ring-red-400 focus:border-red-400 <?php unset($message);
