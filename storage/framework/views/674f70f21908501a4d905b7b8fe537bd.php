...
<?php $__env->startSection('title', 'Dashboard - Arsip Surat Ngodingyuk'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 card-hover relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e($totalSurat); ?></p>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 card-hover relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e($suratMasuk); ?></p>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 card-hover relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-3xl font-bold text-gray-900"><?php echo e($suratKeluar); ?></p>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="<?php echo e(route('surat.create')); ?>" class="group flex flex-col items-center p-6 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl hover:from-indigo-100 hover:to-purple-100 transition-all duration-200 border border-indigo-100 card-hover">
            ...
            <a href="<?php echo e(route('surat.index', ['jenis' => 'masuk'])); ?>" class="group flex flex-col items-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl hover:from-green-100 hover:to-emerald-100 transition-all duration-200 border border-green-100 card-hover">
            ...
            <a href="<?php echo e(route('surat.index', ['jenis' => 'keluar'])); ?>" class="group flex flex-col items-center p-6 bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl hover:from-orange-100 hover:to-amber-100 transition-all duration-200 border border-orange-100 card-hover">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="group flex flex-col items-center p-6 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl hover:from-blue-100 hover:to-cyan-100 transition-all duration-200 border border-blue-100 card-hover">
        ...
        <div class="space-y-3">
            ...
            <?php if($recentSurats->count() > 0): ?>
                ...
                <div class="flex items-center p-4 bg-gradient-to-r from-gray-50 to-gray-50 rounded-xl hover:from-indigo-50 hover:to-purple-50 transition-all duration-200 border border-gray-100 hover:border-indigo-200 card-hover">
                    ...
                    <?php endif; ?>
                    <div class="flex-1">
                        <p class="font-semibold text-gray-900 mb-1"><?php echo e($surat->perihal); ?></p>
                        <div class="flex items-center space-x-2 text-xs text-gray-600">
                            ...
                            <span class="text-gray-500"><?php echo e($surat->nomor_surat); ?></span>
                            <span class="text-gray-400">•</span>
                            <span class="text-gray-500"><?php echo e($surat->created_at->diffForHumans()); ?></span>
                        </div>
                    </div>
                    <a href="<?php echo e(route('surat.show', $surat)); ?>" class="w-10 h-10 bg-indigo-100 hover:bg-indigo-600 rounded-lg flex items-center justify-center text-indigo-600 hover:text-white transition-all duration-200 ml-4">
            ...
            <?php else: ?>
                <div class="text-center py-12 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border-2 border-dashed border-gray-300">
                    ...
                    <a href="<?php echo e(route('surat.create')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl font-medium">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\IZSAA\BBB\LARAVEL\SURAT\arsip-surat\resources\views/dashboard.blade.php ENDPATH**/ ?>